...
# generics this is a view that's pre-made for us that allows us to easily make a API that creates an object in a database using the serialize that we're going to provide.
